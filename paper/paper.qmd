...
data_long <- data %>%
  ...
  pivot_longer(cols = c(current_price, old_price), values_to = "price")

# Create the line plot
ggplot(data_long, aes(x = product_vendor, y = price, color = price_type, linetype = price_type, group = interaction(price_type, product_vendor))) +
  geom_line() +
  geom_point() +
...
Sale Behavior Analysis at Voila:
...
Conclusion on Price Manipulation:
