...
The dataset consists of price data for Apples Ambrosia from two grocery vendors: NoFrills and Loblaws. For each vendor, prices are observed during periods labeled as "SALE" (Loblaws) and regular pricing periods (NoFrills). The analysis investigates the following:
